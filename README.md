...
Built as a college OOP project, this game demonstrates solid software engineering principles using **polymorphism, inheritance hierarchies, double-dispatch collision handling**, and a clean **component-based architecture**.
